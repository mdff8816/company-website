  ...
  return (
    <div className=" p-14 mb-5">
      <div className="container mx-auto flex justify-center items-center">
        <h1 className="text-black font-bold text-2xl mb-10">Over 50+ Clients</h1>
      </div>
      <div className="container mx-auto flex justify-center items-center flex-wrap gap-4 mt-4">
        <img src="/asus-rog-1-logo-svgrepo-com.svg" className="h-12 w-12" />
        <img
          src="/bca-bank-central-asia-logo-svgrepo-com.svg"
          className="h-12 w-12"
        />
        <img
